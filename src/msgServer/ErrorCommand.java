...
public class ErrorCommand implements Command {
	 ...
	 *            in A reader connected to the InputStream
	 * @param BufferedWriter
	 *            out A writer connected to the OutputStream
	 * @param MsgSvrConnection
	 *            serverConn The class modelling the connection
	 * @param String
	 *            message The message describing the error
	 */
	public ErrorCommand(BufferedReader in, BufferedWriter out, MsgSvrConnection serverConn, String message) {
		this.out = out;
